...
CREATE INDEX learning_resources_subject_idx ON public.learning_resources(subject_id) WHERE is_active;
CREATE INDEX learning_resources_category_idx ON public.learning_resources(category_id) WHERE is_active;
