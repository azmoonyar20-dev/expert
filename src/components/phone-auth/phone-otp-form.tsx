...
import { normalizeIranMobile, phoneSchema, toAsciiDigits, toLocalMobile, toPersianDigits } from "@/lib/phone-auth/phone";
    ...
    <form className="space-y-5" onSubmit={submitCode} noValidate>
      <div className="flex items-center justify-between gap-2 rounded-lg bg-muted/60 p-3 text-sm">
        <span className="flex items-center gap-2 text-muted-foreground">
          ...
          کد به <span dir="ltr" className="font-medium tabular-nums text-foreground">{toPersianDigits(toLocalMobile(phone))}</span> ارسال شد
        </span>
        <Button
          type="button"
          variant="link"
