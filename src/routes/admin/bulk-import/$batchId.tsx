...
export const Route = createFileRoute("/admin/bulk-import/$batchId")({
  head: () => ({
    meta: [
      ...
      { name: "description", content: "جزئیات یک دسته ورود گروهی سوالات به همراه خطاها و بازگردانی" },
...
function BatchDetailPage() {
  ...
  const rollback = useMutation({
    mutationFn: () => rpc<{ deleted: number }>("admin_rollback_question_import", { p_batch_id: batchId }),
    onSuccess: (res) => {
